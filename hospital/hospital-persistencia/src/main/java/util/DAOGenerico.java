...
public class DAOGenerico implements Serializable {
	 ...
	 * @param entityManager manejador de entidades.
	 */
	 ...
	 * @param id del registro para ser referenciado en bd
	 ...
	 * entidad.
	 * @param id del registro a ser destruido
	 */
	 ...
	 * @version 1.0
	 * @param nombreNamedQuery nombre de la NamedQuery.
	 * @param params parametros. @return, la lista de entidades.
	 */
	 ...
	 * @param nombreNamedQuery, nombre de la NamedQuery.
	 * @param params , parametros. @return, la lista de entidades.
	 * @param start, inicio de la paginacion
	 * @param end, fin de la paginacion
	 */
