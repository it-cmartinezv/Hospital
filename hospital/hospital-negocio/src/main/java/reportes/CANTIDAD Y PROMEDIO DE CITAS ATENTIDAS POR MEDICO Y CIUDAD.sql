/*
 * CANTIDAD Y PROMEDIO DE CITAS ATENTIDAS POR MEDICO Y CIUDAD
 */
 -- VISTA
  CREATE OR REPLACE VIEW REPORTES_CARLOS_MARTINEZ AS
  ...
  -- PROCEDIMIENTO
  CREATE OR REPLACE PROCEDURE CITAS_BY_MEDICO_CIUDAD(newcursor OUT SYS_REFCURSOR)
  AS
